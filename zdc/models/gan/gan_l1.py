...
from zdc.utils.losses import xentropy_loss, mae_loss
from zdc.utils.nn import init, forward, get_layers
from zdc.utils.train import train_loop, default_generate_fn


def gen_loss_fn(gen_params, disc_params, state, forward_key, img, cond, rand_cond, model, l1_weight=0.001):
    ...
    l1_loss = mae_loss(generated, img)
...
if __name__ == '__main__':
    ...
    train_loop(
        'gan_l1', train_fn, None, generate_fn, (r_train, p_train), (r_val, p_val), (r_test, p_test),
