...
from zdc.utils.nn import init, get_layers, opt_with_cosine_schedule
...
if __name__ == '__main__':
    ...
    train_loop(
        'convnext_gan', train_fn, None, generate_fn, (r_train, p_train, f_train), (r_val, p_val, f_val), (r_test, p_test, f_test),
